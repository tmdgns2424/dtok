    ...
    $.alopex.page({
        ...
        setGrid : function() {
            ...
            $("#grid").alopexGrid({
                ...
                columnMapping : [
                    ...
                    { columnIndex : 6, key  : "REQ_SALE_DEPT_ORG_NM", 	title : "희망영업국",   align : "center", width : "120px" },
                    { columnIndex : 7, key  : "REQ_SALE_TEAM_ORG_NM",   title : "희망영업팀",   align : "center", width : "80px"  },
                    { columnIndex : 8, key  : "APP_SALE_DEPT_ORG_NM",   title : "지정영업국",   align : "center", width : "120px" },
        ...
        setCodeData : function() {
            $.PSNMUtils.setCodeData([ 
                ...
                $("#CNTRT_ST_CD").children("[value='1']").remove();
                }
            );
        },
        searchList : function(param){
            ...
            $.alopex.request('agn.AGNTMGMT@PAGENTCNTRT001_pSearchAgentCntrt', {                
    			data : ["#searchTable", function(){
    					this.data.dataSet.fields.DIV 	   = "HEAD";
                ...
                success: ["#grid", "#CNTRT_ST_CNT2", "#CNTRT_ST_CNT3", "#CNTRT_ST_CNT4", "#CNTRT_ST_CNT5", "#CNTRT_ST_CNT6", function(res) {

...
<head>
    ...
    $.alopex.page({
        ...
        init : function(id, param) { 
            ...
            /* 
            if( !param.SALE_DEPT_ORG_ID ){
                $("#searchForm").setData({SALE_DEPT_ORG_ID:"01010000"});
            } */
            ...
            $("#searchTable").setData({APL_ST_CD:"02"});   //처리상태는 접수(2)상태로 고정
        ...
        setGrid : function() {
            ...
            $("#grid").alopexGrid({
                ...
                columnMapping : [
                    ...
                    { columnIndex : 4, key : "HDQT_PART_ORG_NM", title : "담당본사파트",   align : "center", width : "130px", hidden : true},
                    { columnIndex : 5, key : "REQ_DSM_HEADQ_NM", title : "담당영업국",     align : "center", width : "130px" 			   },
                ...
                on : {
                    'cell' : {
                        "dblclick" : function(data, eh, e) {    //표준 : 더블클릭시 상세페이지로 이동함.
                        	...
                        	$a.navigate("headAgentCnslMgmtDtl.jsp", param);
                        }
                    }
                }
            });
        ...
        setCodeData : function() {
            $.PSNMUtils.setCodeData([
                ...
                { t:'org3',  'elemid' : 'SALE_DEPT_ORG_ID', 'header' : '-선택-' }, //[영업국] 목록 조회
    ...
    <div id="searchDiv" class="textAR"> 
		<form id="searchForm" onsubmit="return false;">
			...
			<tr>
			    ...
			    <th scope="col" class="fontred">영업국</th>
                <td class="tleft">
                    <select id="SALE_DEPT_ORG_ID" data-bind="options:options_SALE_DEPT_ORG_ID, selectedOptions:SALE_DEPT_ORG_ID" data-type="select" data-wrap="false"
                            data-validation-rule="{required:true}" 
                            data-validation-message="{required:$.PSNM.msg('E012', ['영업국'])}" style="width:150px;">
                    </select>  
                </td>
			    <th >처리상태</th>
				<td class="tleft">
				    <select id="APL_ST_CD" data-type="select" data-bind="options:options_APL_ST_CD, selectedOptions:APL_ST_CD" data-disabled="true"></select>
				</td>
			</tr>
			</table>
		</form>

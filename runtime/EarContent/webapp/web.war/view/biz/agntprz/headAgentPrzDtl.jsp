	    ...
	    <form id="form" onsubmit="return false;">
	        ...
	        <table class="board02" style="width:100%;">
	        	...
	        	<tr>
					...
					<td class="tleft">
						<input id="PRZ_DT" name="PRZ_DT" data-bind="value:PRZ_DT" data-type="dateinput" style="width:100px;" data-image="<c:out value='${pageContext.request.contextPath}'/>/image/ico_calendar.png" data-disabled="true"/>
					</td>

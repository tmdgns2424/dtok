                    ...
                    "cell" : {
    					"dblclick" : function(data, eh, e) {
    						if(data._index.column != 0) {
    			            	...
    			            	$a.navigate("teamAgentPrzDtl.jsp", param);
    						}
    					}
    				}
                }
...
<div id="contents">
    ...
    <div id="searchDiv" class="textAR">
		<form id="searchForm" onsubmit="return false;">
			...
			<p>
				<font size="2" color="red">포상 당시의 에이전트 정보로 조회하시기 바랍니다.</font> 
			</p>
        </form>
    </div>

    <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>포상관리</b>
        <p class="ab_pos2">

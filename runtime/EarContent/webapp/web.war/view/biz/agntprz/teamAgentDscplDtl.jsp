	    ...
	    <form id="form" onsubmit="return false;">
	        ...
	        <table class="board02" style="width:100%;">
	        	...
	        	<tr>
					...
					<td class="tleft">
						<input id="DISPL_DT" name="DISPL_DT" data-bind="value:DISPL_DT" data-type="dateinput" style="width:100px;" data-disabled="true" data-image="<c:out value='${pageContext.request.contextPath}'/>/image/ico_calendar.png"/>
					</td>

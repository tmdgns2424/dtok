    ...
    $.alopex.page({
        ...
        setEventListener : function() {
        	...
        	$("#btnNew").click(function(){
            	...
            	$a.navigate("teamPrdFtftPlanDtl.jsp", param);
            });
        ...
        setGrid : function() {
            $("#grid").alopexGrid({
                ...
                rowInlineEdit : true,
                columnMapping : [
                    { columnIndex : 0, key : "CNSL_DT",            	title : "계획일자",		align : "center", 	width : "100px" },
                    { columnIndex : 1, key : "CNSL_ACT_CD",  		title : "시행여부",		align : "center", 	width : "50px"  },
                    ...
                    { columnIndex : 8, key : "CNSLR_CD", 			title : "면담자코드",		align : "center", 	width : "100px"	},
                    { columnIndex : 9, key : "CNSLR_RPSTY_NM", 		title : "면담자직책",		align : "center", 	width : "70px"	},
                    { columnIndex : 10, key : "CNSLR_NM", 			title : "면담자명",		align : "center", 	width : "100px"	},
                    { columnIndex : 11, key : "CNSL_RSN_NM", 		title : "면담목적",		align : "left", 	width : "150px"	}
                ],
                on : {
        ...
        setCodeData : function() {
            $.PSNMUtils.setCodeData([
				{ t:'code',  'elemid' : 'CNSL_ACT_CD', 'codeid' : 'DSM_CNSL_ACT_CD', 'header' : '-전체-' }                                     
                /*
				{ t:'code',  'elemid' : 'CNSL_ST_CD', 'codeid' : 'DSM_SALES_APRV_PROC_ST_CD', 'header' : '-전체-' }
                */
            ]);
        },
        searchList: function(param) {
            ...
            $.alopex.request("biz.AGNTFTFT@PAGENTCNSLPLN001_pSearchAgentCnslPln", {
...
<div id="contents">
    ...
    <div class="content_title">
        <div id="ub_txt6">
            <span class="txt6_img"><b id="sub-title">면담계획/정기면담</b>
		...
		<form id="searchForm" onsubmit="return false;">
            ...
            <tr>
				...
				<td class="tleft" colspan="5">
                    <select id="CNSL_ACT_CD" data-bind="options: options_CNSL_ACT_CD, selectedOptions: CNSL_ACT_CD" data-type="select" ></select>
                </td>
            </tr>
            <!--
            <tr>
                <th>진행상태</th>
				<td class="tleft" colspan="5">
                    <select id="CNSL_ST_CD" data-bind="options: options_CNSL_ST_CD, selectedOptions: CNSL_ST_CD" data-type="select" ></select>
                </td>
            </tr>
            -->
            </table>
    ...
    <div id="totcount" class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>면담계획/정기면담</b>
    	(<b>총 <label data-bind="text:TOT_CNT">0</label>건</b> : 완료 <label data-bind="text:CNT1">0</label>, 미완료 <label data-bind="text:CNT2">0</label>)
        <p class="ab_pos2">

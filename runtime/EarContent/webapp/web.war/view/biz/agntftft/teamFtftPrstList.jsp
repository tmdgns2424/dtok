...
<div id="contents">
    ...
    <div id="searchDiv" class="textAR">
		<form id="searchForm" onsubmit="return false;">
            ...
            <tr>
                ...
                <td class="tleft">
					<input id="CNSL_DT" name="CNSL_DT" data-type="dateinput" data-pickertype="monthly" data-bind="value:CNSL_DT" style="width:80px;" data-image="<c:out value='${pageContext.request.contextPath}'/>/image/ico_calendar.png" style="width:60px;"/>
				</td>
    ...
    <div id="totcount" class="floatL4">
    	<img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>월별 면담 진행 현황</b>
    	(<b>총 <label data-bind="text:TT_CNT">0</label>건</b> : 정기면담 <label data-bind="text:R_CNT">0</label>, 수시면담 <label data-bind="text:T_CNT">0</label>)
    </div>
    <!-- main grid -->
    <div id="grid1" data-bind="grid:grid"></div>

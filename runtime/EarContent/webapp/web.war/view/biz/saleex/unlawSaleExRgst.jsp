    ...
    $.alopex.page({
        ...
        setEventListener : function() {
            $("#btnSave").click(function(){
            	...
            	if( $.PSNM.confirm("I004", ["저장"] ) ){
                	...
                	$.alopex.request("biz.SALEEX@PUNLAWSALEEX001_pSaveUnlawSaleEx", {
                        data: requestData,
                        success: function(res) { 
                            $a.navigate("unlawSaleExList.jsp", _param);
                        }
                    });
            	}
            });
            ...
            $("#btnDel").click(function(){
            	if( $.PSNM.confirm("I004", ["삭제"] ) ){
            		var id = _param.data != null ? _param.data.UNLAW_MGMT_NUM : "";
                	$.alopex.request("biz.SALEEX@PUNLAWSALEEX001_pDeleteUnlawSaleEx", {
                		data: {dataSet: {fields: {UNLAW_MGMT_NUM : id}}},
                        success : function(res) {
                        	$a.navigate("unlawSaleExList.jsp", _param);
                        }
                    });
        ...
        setViewData : function() {
        	...
        	if($.PSNMUtils.isNotEmpty(id)){
        		$.alopex.request("biz.SALEEX@PUNLAWSALEEX001_pDetailUnlawSaleEx", {
            		data: {dataSet: {fields: {UNLAW_MGMT_NUM : id}}},
                    success:["#form",  function(res) {
                    	
                    	$("#UNLAW_SALE_EX_CTT").ckeditor();
        ...
        setFileUpload : function () {
        	$.PSNMUtils.setFileUploadAndGrid("UNL", "#fileupload", "#gridfile");
        }
    });
...
<div id="contents">
    ...
    <div class="content_title">
        <div class="ub_txt6">
            <span class="txt6_img"><b>불/편법영업사례</b><span class="notice-more"> <img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a6.gif"> 
    ...
    <!--view_list area -->
    <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>불/편법영업사례</b></div>

    <!--view_table area -->
    <div class="view_list">

        <form id="form" onsubmit="return false;">
        	<input type="hidden" id="UNLAW_MGMT_NUM" name="UNLAW_MGMT_NUM"  data-bind="value:UNLAW_MGMT_NUM"/>
        	<div>
	            ...
	            <tr>
	                <td colspan="4" class="tleft">
	                    <textarea id="UNLAW_SALE_EX_CTT" name="UNLAW_SALE_EX_CTT" data-type="textarea" data-bind="value:UNLAW_SALE_EX_CTT" rows="10" cols="80" 
	                              data-validation-rule="{required:true}" 

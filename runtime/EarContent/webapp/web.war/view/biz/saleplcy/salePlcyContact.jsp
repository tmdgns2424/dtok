...
<head>
    ...
    $.alopex.page({
        ...
        setViewData : function(param) {
        	var dsmSalesPlcyId 	= param != null ? param.DSM_SALES_PLCY_ID : "";
        	var ymd 			= param != null ? param.YMD : "";
        		ymd 			= ymd == "합계" ? "" : ymd;
        	var saleDeptOrgId 	= param != null ? param.SALE_DEPT_ORG_ID : "";
        	
        	$.alopex.request("biz.SALEPLCY@PSALESPLCY001_pSearchSalesPlcyContact", {
        		data: {dataSet: {fields: {DSM_SALES_PLCY_ID : dsmSalesPlcyId
        								, YMD : ymd
...
<div id="contents">
    ...
    <div class="pop_header">
        ...
        <div class="textAR">
            ...
            <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>영업정책 접속현황</b>
                <p class="ab_pos2">

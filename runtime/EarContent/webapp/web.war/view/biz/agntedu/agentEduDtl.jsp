    ...
    $.alopex.page({
        ...
        setEventListener : function() {
            $("#btnModi").click(function(){
            	$a.navigate("agentEduRgst.jsp", _param);
            });
            ...
            $("#btnDel").click(function(){
            	if(  $.PSNM.confirm("I004", ["삭제"] ) ){
                	...
                	$.alopex.request("biz.AGNTEDU@PAGENTEDU001_pDeleteAgentEdu", {
            ...
            $("#btnExcelPage").click(function(){
            	var oExcelMetaInfo = {
                        filename  : "참석자현황및결과.xls",
                        sheetname : "참석자현황및결과",
                        gridname  : "grid1" //그리드ID 
                    };
            	
            	$.PSNMUtils.downloadExcelPage("grid1", oExcelMetaInfo);
            });
        },
...
<div id="contents">
    ...
    <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>참석자현황 및 결과</b>
    	<p class="ab_pos2">

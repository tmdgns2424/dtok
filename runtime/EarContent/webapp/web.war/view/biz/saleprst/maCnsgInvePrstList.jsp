...
<head>
    ...
    $.alopex.page({
        ...
        init : function(id, param) { 
            ...
            $("#searchForm").setData($.PSNM.getSession());
            $("#AGNT_NM").val($.PSNM.getSession("SALE_AGNT_ORG_NM"));
            $("#AGNT_ID").val($.PSNM.getSession("SALE_AGNT_ORG_ID"));
          //MA가 아니면 조회 불가.
...
<div id="contents">
    ...
    <div id="searchDiv" class="textAR">
		<form id="searchForm" onsubmit="return false;">
            <input type="hidden" id="HDQT_TEAM_ORG_ID" name="HDQT_TEAM_ORG_ID"  data-bind="value: HDQT_TEAM_ORG_ID" data-type="textinput"/>
            ...
            <input type="hidden" id="AGNT_ID"		   name="AGNT_ID"  			data-bind="value: AGNT_ID" 			data-type="textinput"/>
            ...
            <tr>
				...
				<td class="tleft">
                    ...
                    <input id="AGNT_ID2" name="AGNT_ID2" data-bind="value:AGNT_ID2" data-type="textinput" data-disabled="true" style="width:70px;" />
                </td>
                <th>상품명</th>
				<td class="tleft">

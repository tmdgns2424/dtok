    ...
    $.alopex.page({
        ...
        setGrid : function() {
            $("#gridMain").alopexGrid({
                ...
                height : "610px",
                headerGroup : [
                  				 { fromIndex:6,	 toIndex:14, 	title: "개통상품"	}
                ], 
                ...
                columnMapping : [
                                 ...
                                 { columnIndex : 6,  key  : "QTY_TOT",    					title : "합계",			align : "center", 	width : "100px" },
                                 { columnIndex : 7,  key  : "QTY_NEW", 						title : "010신규",		align : "center", 	width : "100px"	},
                                 { columnIndex : 8,  key  : "QTY_KMNP", 					title : "KMNP",			align : "center", 	width : "100px"	},
                                 { columnIndex : 9,  key  : "QTY_LMNP", 					title : "LMNP",			align : "center", 	width : "100px" },
                                 { columnIndex : 10,  key  : "QTY_EMNP", 					title : "기타 MNP",		align : "center", 	width : "100px"	},
                                 { columnIndex : 11, key  : "QTY_EQP_CHG", 					title : "기변",			align : "center", 	width : "100px"	},
                                 { columnIndex : 12, key  : "QTY_ETC", 						title : "기타",			align : "center", 	width : "100px"	},
                                 { columnIndex : 13, key  : "QTY_USIM", 					title : "USIM",			align : "center", 	width : "100px"	},
                                 { columnIndex : 14, key : "QTY_SMART", 					title : "스마트Device",	align : "center", 	width : "100px"	},
                                 { columnIndex : 15, key : "QTY_NEQP", 						title : "공기계",			align : "center", 	width : "100px"	}
                             ],
                footer : {
		        			position : "top",
		        			footerMapping : [
		        				{columnIndex:6, 	render:"sum(QTY_TOT)",			align:"center"	},
		        				{columnIndex:7, 	render:"sum(QTY_NEW)", 			align:"center"	}, 
		        				{columnIndex:8, 	render:"sum(QTY_KMNP)", 		align:"center" 	}, 
		        				{columnIndex:9, 	render:"sum(QTY_LMNP)", 		align:"center" 	}, 
		        				{columnIndex:10, 	render:"sum(QTY_EMNP)", 		align:"center" 	},
		        				{columnIndex:11, 	render:"sum(QTY_EQP_CHG)", 		align:"center"	},
		        				{columnIndex:12, 	render:"sum(QTY_ETC)", 			align:"center"	},
		        				{columnIndex:13, 	render:"sum(QTY_USIM)", 		align:"center"	},
		        				{columnIndex:14,	render:"sum(QTY_SMART)", 		align:"center"	},
		        				{columnIndex:15, 	render:"sum(QTY_NEQP)", 		align:"center"	}
...
//         }
        ...
        $.alopex.request("biz.SALEPRST@PSALEPRST001_pSearchAgentRsltPrst", {
...
<div id="contents">
    ...
    <div class="content_title">
        <div class="ub_txt6">
            <span class="txt6_img"><b id="sub-title">에이전트별 실적현황</b>
    ...
    <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>에이전트별 실적현황</b>
        <p class="ab_pos2">

    ...
    $.alopex.page({
        ...
        setCodeData : function() {
            $.PSNMUtils.setCodeData([
            	...
            	$("#form").setData( {RCV_OWNR_CD :"01", RCV_OWNR_NM:"01"} );
            });
        },
    });
	    ...
	    <form id="form" onsubmit="return false;">
	        ...
	        <table class="board02" style="width:100%;">
	        	...
	        	<tr>
					...
					<td class="tleft">
						<select id="RCV_OWNR_CD" name="RCV_OWNR_CD" data-bind="options:options_RCV_OWNR_CD, selectedOptions: RCV_OWNR_CD" data-type="select"></select>

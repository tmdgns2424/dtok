        ...
        setGrid : function() {
            $("#gridScrbClm").alopexGrid({
                ...
                columnMapping  : [
                    ...
                    { columnIndex : 15, key : "SCRB_LRG_SEQ", 		   title : "고액차수",		align : "center", 	width : "100px"	},
                    { columnIndex : 16, key : "SCRB_LRG_AMT", 		   title : "고액금액",		align : "center", 	width : "100px"	},
                    { columnIndex : 17, key : "OP_CNT", 		       title : "건수",		    align : "center", 	width : "100px"	},
                    { columnIndex : 18, key : "OP_CLS_DTM",		       title : "처리시한",		align : "center", 	width : "100px"	},
                    { columnIndex : 19, key : "FNSH_DTM", 		       title : "처리완료일시",	align : "center", 	width : "100px"	},
                    { columnIndex : 20, key : "SELLER_PEN_AMT", 	   title : "판매자",		    align : "center", 	width : "100px", 	render:{type : "string", rule:"comma"} },
                    { columnIndex : 21, key : "TEAM_LDR_PEN_AMT", 	   title : "국장",		    align : "center", 	width : "100px", 	render:{type : "string", rule:"comma"} },
                    { columnIndex : 22, key : "DRTR_PEN_AMT", 		   title : "팀장",		    align : "center", 	width : "100px", 	render:{type : "string", rule:"comma"} },                    
                ],
                on : {
    					...
    					"click" : function(data, eh, e) {
    						if(data._index.column != 0) {
    							var param = $("#searchTable").getData({selectOptions:true});
    			            	    ...
    			            	    $a.navigate("scrbClmDtl.jsp", param);
    						}
    					}
    				}
                }
...
<div id="contents">
    ...
    (총&nbsp;<span id="TOT_CNT" data-bind="text:TOT_CNT">0</span>&nbsp;건&nbsp;:&nbsp;<b>처리중&nbsp;<span id="PRC_CNT" data-bind="text:PRC_CNT">0</span>&nbsp;건</b>,&nbsp;재처리중&nbsp;<span id="REPRC_CNT" data-bind="text:REPRC_CNT">0</span>&nbsp;건,&nbsp;처리완료&nbsp;<span id="END_CNT" data-bind="text:END_CNT">0</span>&nbsp;건)
        <p class="ab_pos2">

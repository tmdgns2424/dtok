...
<head>
    ...
    function setVisible( res ){
    	if( res.dataSet.fields.CLM_TYP_CD == "05" ){
	    ...
	    <form id="form" onsubmit="return false;">
	        ...
	        <table class="board02" style="width:100%;">
	        	...
	        	<tr>
	         	...
	         	<tr>
					...
					<td class="tleft" colspan="3">
						<input id="SCRB_LRG_SEQ" data-bind="value:SCRB_LRG_SEQ" data-type="textinput" data-disabled="true" control-grp="scrb_lrg" data-keyfilter-rule="digits" data-disabled="true" style="width:150px">차
						<input id="SCRB_LRG_AMT" data-bind="value:SCRB_LRG_AMT" data-type="textinput" data-disabled="true" control-grp="scrb_lrg" data-keyfilter-rule="digits" data-disabled="true" style="width:150px">원
					</td>
	         	</tr>	   
	         	<tr>
	            	<th scope="col">등록자</th>
	        ...
	        <table class="board02" style="width:100%;">
	        	...
	        	<tr>
					...
					<th scope="col" class="fontred">접수 매출번호</th>
					<td class="tleft">

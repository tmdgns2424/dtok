    ...
    $.alopex.page({
        ...
        setData : function() {
        	...
        	$.alopex.request("biz.CUSTPGCV@PCUSTPGCV001_pSearchCustPgcvDtl", {
                ...
                success:["#form", "#form1", "#gridCustPgcvOp", "#gridfile", "#gridfile2", function(res) {
                	 $("#RCV_CTT").ckeditor();     
                	...
                	setVisible( _searchData, res.dataSet.recordSets.gridCustPgcvOp.nc_recordCount );
                }]
            });
        },
        setGrid : function() {
        ...
        setEventListener : function() {
        	...
        	$("#btnDelete").click(function(){
            	...
            	$.alopex.request("biz.CUSTPGCV@PCUSTPGCV001_pDeleteCustPgcv", {
            		data: requestData,
                    success: function(res) {
                    	 if ( ! $.PSNM.success(res) ) { //서버측 FAIL응답
                    		 return false;
	        ...
	        <table class="board02" style="width:100%;">
	        	...
	        	<tr>
					...
					<td class="tleft">
                    	...
                    	<input id="RCV_OWNR_NM" name="RCV_OWNR_NM" data-bind="value:RCV_OWNR_CD" data-type="textinput" size="2" data-disabled="true" maxlength="2">
					</td>
	         	</tr>
	        	<tr>

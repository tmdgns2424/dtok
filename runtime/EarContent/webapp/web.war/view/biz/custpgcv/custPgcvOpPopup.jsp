...
<head>
    ...
    $a.page({
        init : function(id, param) {
        	...
        	setVisible( _param.CUST_PGCV_ST_CD );
        },
        setData : function() {           	
           	$.alopex.request("biz.CUSTPGCV@PCUSTPGCV001_pSearchCustPgcvOpDtl", {
        ...
        setEventListener : function() {
            ...
            $("#btnDelete").click(function(){
            	...
            	$.alopex.request("biz.CUSTPGCV@PCUSTPGCV001_pDeleteCustPgcvOp", {
            		data: {dataSet: {fields: {RCV_MGMT_NUM:_param.RCV_MGMT_NUM, OP_SEQ:_param.OP_SEQ}}},
                    success: function(res) {
                    	 if ( ! $.PSNM.success(res) ) { //서버측 FAIL응답
                    		 return false;
...
<div id="Wrap"> 
    <div class="pop_header" style="overflow-y: auto;">
	    ...
	    <div class="floatL4"> 
	    	<img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"> <b>내용등록</b>

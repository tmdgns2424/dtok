    ...
    $.alopex.page({
        ...
        setEventListener : function() {
        	...
        	$("#btnNew").click( function(){
        		$a.navigate("custPgcvRgst.jsp", null);
        	} );
        ...
        setGrid : function() {
            $("#gridCustPgcv").alopexGrid({
                ...
                columnMapping  : [
                    ...
                    { columnIndex : 16, key : "OP_CLS_DTM",		       title : "처리시한",		align : "center", 	width : "105px"	},
                    { columnIndex : 17, key : "FNSH_DTM", 		       title : "처리완료일시",	align : "center", 	width : "105px"	},
                    ...
                    { columnIndex : 21, key : "CUST_PGCV_ST_CD", 	   title : "상태코드",		align : "center", 	width : "100px",    hidden: true },
                ],
                on : {
    					...
    					"dblclick" : function(data, eh, e) {
    						if(data._index.column != 0) {
    							var param = $("#searchTable").getData({selectOptions:true});
    			            	    ...
    			            	    $a.navigate("custPgcvDtl.jsp", param);
    						}
        ...
        excelPage : function(){
            ...
            $.PSNMUtils.downloadExcelPage("gridCustPgcv", oExcelMetaInfo, [21]);
        }
    });

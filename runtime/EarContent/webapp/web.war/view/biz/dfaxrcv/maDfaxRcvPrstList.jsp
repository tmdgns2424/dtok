    ...
    $.alopex.page({
        ...
        setEventListener : function() {
        	...
        	$("#btnRequest").click(function(){
        		...
        		var param = {};
        			param["data"] = data;
        			param["data"][0].BIZ_APRV_REQ_CL_CD = "01"; // 승인요청구분(MA)
...
<div id="contents">
    ...
    <div class="content_title">
        <div id="ub_txt6">
            <span class="txt6_img"><b id="sub-title">Fax현황/승인요청</b>
    ...
    <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>Fax현황/승인요청</b>
        <p class="ab_pos2">

...
<head>
    ...
    <title>판매 우수 팀장 현황 - PS&Marketing</title>
        ...
        setGrid : function() {
            $("#gridbestteam").alopexGrid({
                ...
                columnMapping : [
                    ...
                    { columnIndex : 3, key : "AGNT_NM",          title : "팀장명",         align : "center",  width : "150px" },
    ...
    function pSearchBestTeam(param) {
        $.alopex.request('biz.SALEPRST@PSALEPRST002_pSearchBestTeam', {
            data: function() {
                _debug("<판매우수팀장현황> <request.data> 파라미터 (this.data.dataSet.fields) : " + JSON.stringify(this.data.dataSet.fields));
            },
            success: ['#gridbestteam', function(res) {
                //_debug("<판매우수팀장현황> <request.success> 결과데이터 : " + JSON.stringify(res));
            }]
        });
    }
...
<div id="contents">
    ...
    <div class="pop_header">
        ...
        <div class="textAR">
            ...
            <div class="floatL4"> <img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"> <b>판매 우수 팀장 현황</b>
                <p class="ab_pos1">

            	...
            	if ( ! $.PSNM.isValid("#form") ) {
               	...
               	if(  $.PSNM.confirm("I004", ["저장"] ) ){
					var requestData = $.PSNMUtils.getRequestData("form", "gridfile");
                   	$.alopex.request("com.PPCNSLMGMT@PP2PCNSLMGMT001_pSaveP2pCnsl", {
	                    data: requestData,
	            ...
	            <table class="board02" style="width:100%;">
		            ...
		            <tbody>
			            ...
			            <tr>
			                ...
			                <td class="tleft">
			                	<input id="HDQT_PART_ORG_NM" name="HDQT_PART_ORG_NM" data-type="textinput" data-bind="value:HDQT_PART_ORG_NM" style="width:120px" data-disabled="true"/>
			                </td>
			            	<th scope="col">영업국명</th>
			                <td class="tleft">
			                	<input id="SALE_DEPT_ORG_NM" name="SALE_DEPT_ORG_NM" data-type="textinput" data-bind="value:SALE_DEPT_ORG_NM" style="width:120px" data-disabled="true"/>
			                </td>
			            </tr>
			            <tr>
			                ...
			                <td class="tleft time">
			                	<input id="RGSTR_DT" name="RGSTR_DT" data-type="dateinput" data-bind="value:RGSTR_DT" style="width:100px;" data-disabled="true"/>
			                </td>
			            </tr>
			            <tr>

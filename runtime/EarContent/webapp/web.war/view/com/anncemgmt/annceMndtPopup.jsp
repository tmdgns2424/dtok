    ...
    $.alopex.page({
        ...
        setEventListener : function() {
        	$("#btnExcelPage").click(function(){
            	var oExcelMetaInfo = {
                        filename  : "공지사항필수일별확인현황.xls",
                        sheetname : "공지사항필수일별확인현황",
                        gridname  : "grid" //그리드ID 
                    };
                ...
                on : {
                    "cell" : {
    					"click" : function(data, eh, e) {
    						...
    						data["ANNCE_ID"] 			= _param.data.ANNCE_ID;
    						data["SALE_DEPT_ORG_ID"] 	= data["ID"+data._index.column];
    						
    						$a.popup({
    		                    url: "com/anncemgmt/annceMndtDtlPopup",
    		                    data: data,
    		                    title : "공지사항 필수 확인현황",
    		                    width: 850,
    		                    height: 400
        ...
        setGridMapping : function(param) {
        	...
        	var rgstrDt = param.data != null ? param.data.RGSTR_DT : "";
        	var columnArr = new Array();
        	$.alopex.request("com.ANNCEMGMT@PANNCEMGMT001_pSearchAnnceMndtDept", {
        		data: {dataSet: {fields: {HDQT_PART_ORG_ID : hdqtPartOrgId, RGSTR_DT:rgstrDt}}},
                success:  function(res) {
                	var colList = res.dataSet.recordSets.grid.nc_list;
        ...
        setViewData : function(param, columnArr, hdqtPartOrgId, saleOrgDeptIdArr) {
        	var id = param.data != null ? param.data.ANNCE_ID : "";
        	$.alopex.request("com.ANNCEMGMT@PANNCEMGMT001_pSearchAnnceMndt", {
        		data: {dataSet: {fields: {ANNCE_ID : id, HDQT_PART_ORG_ID : hdqtPartOrgId}}},
                success: function(res) {
...
<div id="contents">
    ...
    <div class="pop_header">
        ...
        <div class="textAR">
            ...
            <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>공지사항 필수 일별 확인현황</b>
                <p class="ab_pos2">

...
%>
    ...
    $.alopex.page({
        ...
        excuteOzReport : function( param ) {
    		var CNTRT_MGMT_NUM        = param.CNTRT_MGMT_NUM;
    		var reprotpullname      = null;
    		var odinames            = null;

   			reprotpullname = "DTOK/agentCntrtReport.ozr"; 
   			odinames = "agentCntrtReport";
    	    ...
    	    var viewerTag = "<object id='OZReportViewer' classid='CLSID:0DEF32F8-170F-46f8-B1FF-4BF7443F5F25' width='100%' height='100%'>"
    		                ...
    		                + "<param name='odi."+odinames+".args1' value=\"CNTRT_MGMT_NUM="+CNTRT_MGMT_NUM+"\">"
    	                    + "</object>";

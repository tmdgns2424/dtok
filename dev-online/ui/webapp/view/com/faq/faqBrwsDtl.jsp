    ...
    $.alopex.page({
        ...
        setEventListener : function() {
            $("#btnList").click(function(){
            	$a.navigate("faqBrwsList.jsp", _param);
            });
        },
...
<div id="contents">
    ...
    <div class="content_title">
        <div class="ub_txt6">
            <span class="txt6_img"><b>FAQ</b><span class="notice-more"> <img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a6.gif"> 

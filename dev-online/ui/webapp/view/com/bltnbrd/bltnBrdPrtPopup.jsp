...
%>
    ...
    $.alopex.page({
        ...
        excuteOzReport : function( param ) {
    		var BLTCONT_ID        = param.BLTCONT_ID;
    		var USER_ID             = param.USER_ID;
    		var reprotpullname      = null;
    		var odinames            = null;

   			reprotpullname = "DTOK/bltnBrdReport.ozr"; 
   			odinames = "bltnBrdReport";
    	    ...
    	    var viewerTag = "<object id='OZReportViewer' classid='CLSID:0DEF32F8-170F-46f8-B1FF-4BF7443F5F25' width='100%' height='100%'>"
    		                ...
    		                + "<param name='odi."+odinames+".args1' value='BLTCONT_ID="+BLTCONT_ID+"''>"
    		                + "<param name='odi."+odinames+".args2' value='USER_ID="+USER_ID+"''>"
    	                    + "</object>";

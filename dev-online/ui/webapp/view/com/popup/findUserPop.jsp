    ...
    $.alopex.page({
        ...
        setEventListener : function() {
            ...
            $("#include").click(function(){
                var oResult = $("#grid1").alopexGrid("dataGet", {_state:{selected:true}});
            ...
            $("#exclude").click(function(){
				var oResult = $("#grid2").alopexGrid("dataGet", {_state:{selected:true}});
        ...
        searchList : function() {
            $.alopex.request("com.CODE@PBASE_pSearchUserPop", {
                data: "#searchTable",

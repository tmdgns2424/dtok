...
<head>
    ...
    <title>불/편법 영업사례 - PS&Marketing</title>
	    	...
	    	case "detail":
	            $.alopex.request('biz.SALEEX@PUNLAWSALEEX001_pDetailUnlawSaleEx', {
	                ...
	                success: function(res) {
	                	$("#EX_CTT").html(res.dataSet.fields.UNLAW_SALE_EX_CTT);
...
<div id="Wrap">
    ...
    <div class="pop_header">
        ...
        <div class="textAR">
            ...
            <div class="floatL4"> <img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"> <b>불/편법 영업사례 내역</b>
                <p class="ab_pos2">
                </p>
            </div>

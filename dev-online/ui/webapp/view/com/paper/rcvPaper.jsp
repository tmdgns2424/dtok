...
<script type="text/javascript">
    ...
    var _TX_SEARCH  = "com.PAPER@PPAPERMGMT001_pSearchRcvPaper";
    var _param;
        ...
        setEventListener : function() { 
            ...
            $("#btnDel").click(function(){
                ...
                if( $.PSNM.confirm("I004", ["삭제"] ) ){
                    ...
                    $.alopex.request("com.PAPER@PPAPERMGMT001_pDeleteRcvPaper", {
                        data: requestData,
        ...
        setGrid : function() {
            $("#gridpaper").alopexGrid({
                ...
                columnMapping : [   //컬럼맵핑     
                    ...
                    { 
                        columnIndex : 5, key : "USER_NM", title : "보낸사람", align: "center", width: "30px"
                    },
                    { 
                    ...
                    { 
                        columnIndex : 7, key : "IS_OPEND", title : "읽었는지 여부", hidden:true
                    },
                    { 
                        columnIndex : 8, key : "RGST_DT", title : "날짜", align : "center", width : "30px" 
                    },
                    { 
                        ...
                        "dblclick" : function(data, eh, e) {
                            if(data._index.column != 0) {
                                var param = $("#searchTable").getData({selectOptions:true});
                                    param["IS_OPEND"]   = data.IS_OPEND; //열람인지아닌지의 여부
                                    param["RCV_USER_ID"]   = data.RCV_USER_ID;  //받은사람의 아이디젖ㅇ
                                    param["ATCH_FILE_YN"]  = data.ATCH_FILE_YN; //파일첨부 여부
                                ...
                                $a.navigate("rcvPaperDtl.jsp", param);
                            }
...
<body>
    ...
    <div class="floatL4">  <img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"> <b>받은쪽지</b>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><font color="red">받은쪽지함에 있는 쪽지는 1달 이후 자동 삭제 됩니다.</font></label>
        <p class="ab_pos2">

...
<head>
    ...
    $.alopex.page({
        ...
        init : function(id, param) { 
            ...
            $("#AGNT_NM").val($.PSNM.getSession("USER_NM"));
          //MA가 아니면 조회 불가.
        ...
        setGrid : function() {
            $("#gridMain").alopexGrid({
                ...
                height : "610px",
                headerGroup : [
                    { fromIndex:2,	 toIndex:10, 	title: "가입유형 별 매출 수량"	}
                ], 
                
                columnMapping : [
                                 { columnIndex : 0,  key  : "MF_COP_NAME", 		    title : "제조사",			align : "center", 	width : "100px" },
                                 { columnIndex : 1,  key  : "MDL",  					title : "상품명",			align : "left", 	width : "100px" },
                                 { columnIndex : 2,  key  : "QTY_TOT",    			title : "합계",			align : "center", 	width : "100px" },
                                 { columnIndex : 3,  key  : "QTY_NEW", 				title : "010신규",		align : "center", 	width : "100px"	},
                                 { columnIndex : 4,  key  : "QTY_KMNP", 				title : "KMNP",			align : "center", 	width : "100px"	},
                                 { columnIndex : 5,  key  : "QTY_LMNP", 				title : "LMNP",			align : "center", 	width : "100px" },
                                 { columnIndex : 6,  key  : "QTY_EMNP", 				title : "기타 MNP",		align : "center", 	width : "100px"	},
                                 { columnIndex : 7, key  : "QTY_EQP_CHG", 			title : "기변",			align : "center", 	width : "100px"	},
                                 { columnIndex : 8, key  : "QTY_ETC", 				title : "기타",			align : "center", 	width : "100px"	},
                                 { columnIndex : 9, key  : "QTY_USIM", 				title : "USIM",			align : "center", 	width : "100px"	},
                                 { columnIndex : 10, key : "QTY_SMART", 				title : "스마트Device",	align : "center", 	width : "100px"	},
                                 { columnIndex : 11, key : "QTY_NEQP", 				title : "공기계",			align : "center", 	width : "100px"	}
                             ],
                footer : {
        			position : "top",
        			footerMapping : [
    			                    
        				{columnIndex:0, 	render:["합계"],					align:"center"	},
...
//         }
        ...
        $.alopex.request("biz.SALEPRST@PSALEPRST001_pSearchProdRsltPrst", {
            data: ["#searchTable", function() {
                this.data.dataSet.fields.APLY_MTH      =  $.PSNMUtils.getDateInput("Search_DT");
                this.data.dataSet.fields.HDQT_TEAM_ORG_ID	 = 	$.PSNM.getSession("HDQT_TEAM_ORG_ID");
                this.data.dataSet.fields.SALE_DEPT_ORG_ID	 = 	$.PSNM.getSession("SALE_DEPT_ORG_ID");
                this.data.dataSet.fields.SALE_TEAM_ORG_ID	 = 	$.PSNM.getSession("SALE_TEAM_ORG_ID");
                this.data.dataSet.fields.AGNT_ID	 = 	$.PSNM.getSession("SALE_AGNT_ORG_ID");
            }],
...
<div id="contents">
    ...
    <div class="content_title">
        <div class="ub_txt6">
            <span class="txt6_img"><b id="sub-title">상품별 실적현황</b>
                <span class="notice-more"> <img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a6.gif">
                <span class="a2">영업정보</span> <span class="a3"> > </span> <span class="a4"><b>영업현황</b></span> 
            </span>
        </div>
    </div>
    ...
    <div id="searchDiv" class="textAR">
		<form id="searchForm" onsubmit="return false;">
            ...
            <tr>
				...
				<td class="tleft">
					<input id="Search_DT" name="Search_DT" data-type="dateinput" data-pickertype="monthly" data-bind="value:Search_DT" data-image="<c:out value='${pageContext.request.contextPath}'/>/image/ico_calendar.png"
					       style="width:60px;"
            ...
            <tr>
                ...
                <th>에이전트명</th>
				<td class="tleft">
                    <input id="AGNT_NM" name="AGNT_NM" data-bind="value:AGNT_NM" data-type="textinput" data-agentid="AGNT_ID" data-disabled="true" style="width:70px;" maxlength="10" />
    ...
    <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>상품별 실적현황</b>
        <p class="ab_pos2">

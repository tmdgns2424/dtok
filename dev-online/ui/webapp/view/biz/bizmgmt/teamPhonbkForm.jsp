...
<div id="contents">
	<div class="content_title">
		<div class="ub_txt6"> <span class="txt6_img"><b>전화번호부</b> <span class="notice-more"> <img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a6.gif"> <span class="a2">영업팀업무</span> <span class="a3"> > </span> <b>회원관리</b> </span> </span> </div>
	</div>
	<!-- find condition area -->
	<div class="textAR">
            <div class="org_wrap">

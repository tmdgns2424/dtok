    ...
    $.alopex.page({
        ...
        setGrid : function() {
            $("#grid").alopexGrid({
                ...
                rowInlineEdit : true,
                columnMapping : [
					{ columnIndex : 0, key  : "DISPL_DT",     		title : "징계일자",      align : "center", 	width : "80px"  },
                    ...
                    { columnIndex : 7, key  : "DISPL_CTT",      	title : "징계내용",   	align : "left", 	width : "250px" },
                    { columnIndex : 8, key  : "DISPL_RSN_NM", 		title : "징계사유",     	align : "left", 	width : "150px" }
...
<div id="contents">
    ...
    <div class="content_title">
        <div id="ub_txt6">
            <span class="txt6_img"><b id="sub-title">징계현황</b>

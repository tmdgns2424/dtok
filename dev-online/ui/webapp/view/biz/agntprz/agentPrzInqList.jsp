    ...
    $.alopex.page({
        ...
        setGrid : function() {
            $("#grid").alopexGrid({
                ...
                rowInlineEdit : true,
                columnMapping : [
					{ columnIndex : 0, key  : "PRZ_DT",     		title : "포상일자",      align : "center", 	width : "80px"  },
                    ...
                    { columnIndex : 7, key  : "PRZ_CL_NM",    		title : "포상구분",      align : "center", 	width : "150px" },
                    { columnIndex : 8, key  : "PRZ_NM",       		title : "포상명", 		align : "center", 	width : "100px" },
                    { columnIndex : 9, key  : "PRZ_CTT",      		title : "포상내용",   	align : "left", 	width : "250px" },
                    { columnIndex : 10, key  : "PRZ_RSN_NM", 		title : "사유",     		align : "left", 	width : "150px" }
...
<div id="contents">
    ...
    <div class="content_title">
        <div id="ub_txt6">
            <span class="txt6_img"><b id="sub-title">포상현황</b>

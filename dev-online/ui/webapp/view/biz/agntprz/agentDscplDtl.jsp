...
<head>
    ...
    $.alopex.page({
        ...
        setEventListener : function() {
            $("#btnSave").click(function(){
            	...
            	if( $.PSNM.confirm("I004", ["저장"] ) ){
                	...
                	$.alopex.request("biz.AGNTPRZ@PAGENTDSCPL001_pSaveAgentDscpl", {
                        data: requestData,
                        success: function(res) { 
                            $a.navigate("agentDscplList.jsp", _param);
                        }
                    });
            	}
            });
            $("#btnDel").click(function(){
            	if(  $.PSNM.confirm("I004", ["삭제"] ) ){
            		var id = _param.data != null ? _param.data.DISPL_MGMT_NUM : "";
                	$.alopex.request("biz.AGNTPRZ@PAGENTDSCPL001_pDeleteAgentDscpl", {
                		data: {dataSet: {fields: {DISPL_MGMT_NUM : id}}},
                        success : function(res) {
                        	$a.navigate("agentDscplList.jsp", _param);
                        }
                    });
        ...
        setViewData : function() {
        	...
        	if($.PSNMUtils.isNotEmpty(displNgmtNum)){
	    ...
	    <form id="form" onsubmit="return false;">
	        ...
	        <table class="board02" style="width:100%;">
	        	...
	        	<tr>
					...
					<td class="tleft">
						<input id="DISPL_DT" name="DISPL_DT" data-bind="value:DISPL_DT" data-type="dateinput" style="width:100px;" data-image="<c:out value='${pageContext.request.contextPath}'/>/image/ico_calendar.png"
						data-validation-rule="{required:true}"
						data-validation-message="{required:$.PSNM.msg('E012', ['징계일자'])}"/>
					</td>
					<th scope="col">징계사유</th>
					<td class="tleft">
						<input id="DISPL_RSN_NM" name="DISPL_RSN_NM" data-bind="value:DISPL_RSN_NM" data-type="textinput" style="width:150px;"/>
					</td>
				</tr>
				<tr>
					<th scope="col">PENALTY내용</th>
					<td class="tleft" colspan="3">
						<input id="DISPL_CTT" name="DISPL_CTT" data-bind="value:DISPL_CTT" data-type="textinput" style="width:800px;"/>
					</td>
				</tr>
				<tr>

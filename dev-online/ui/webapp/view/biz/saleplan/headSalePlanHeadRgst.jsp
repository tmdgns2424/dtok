...
<head>
    ...
    $.alopex.page({
        ...
        setEventListener : function() {
			$("#btnSave").click(function(){
                ...
                if(result){
                	if(  $.PSNM.confirm("I004", ["저장"] ) ){
                   		var requestData = $.PSNMUtils.getRequestData2("form1", "form2", "form3", "gridtrgt", "gridtrgtqty", "gridteam");
                       	$.alopex.request("biz.SALEPLAN@PMTHSALESPLAN001_pSaveMthDsmTrgtHeadq", {
                       		data: requestData,
    	                    success: function(res) { 
			...
			$("#SALE_DEPT_ORG_ID").change(function(){
        ...
        setGridTeam : function () {
        	$("#gridteam").alopexGrid({
                ...
                columnMapping : [
                    ...
                    { columnIndex : 4, key : "ACTV_PRSN_CNT",		title : "활동인원(MA기준)",		align : "center", width : "80px", 	rowspan :{by:1}
	                    //, editable : {type : "text", rule : "comma"}
	                    //, render : {type : "string", rule : "comma"} 
                    },
		...
		setGridExcel : function() {
            ...
            var _excel_grid = {
                ...
                columnMapping : [
                    ...
                    { columnIndex : 3, key : "PRSN_CNT",			title : "등록인원"			},
                    { columnIndex : 4, key : "ACTV_PRSN_CNT",		title : "활동인원(MA기준)"	},
...
<div id="contents">
    ...
    <div class="content_title">
        <div class="ub_txt6">
            ...
            <span class="a2">영업국업무</span> <span class="a3"> > </span><b>판매관리</b></span></span> 
        </div>
    </div>

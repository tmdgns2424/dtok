    ...
    $.alopex.page({
        ...
        setEventListener : function() {
        	...
        	$("#btnExcelAll").click(function(){
            	var oExcelMetaInfo = {
                        filename  : "고객민원발생현황.xls",
                        sheetname : "고객민원발생현황",
                        gridname  : "gridCustPgcvPrst" 
                    };

        		$.PSNMUtils.downloadExcelAll("searchForm", "biz.CUSTPGCV@PCUSTPGCV001_pSearchCustPgcvPrst", "gridCustPgcvPrst", oExcelMetaInfo);
            });
        	$("#btnExcelPage").click(function(){
            	var oExcelMetaInfo = {
                        filename  : "고객민원발생현황.xls",
                        sheetname : "고객민원발생현황",
                        gridname  : "gridCustPgcvPrst" //그리드ID 
                    };
                $.PSNMUtils.downloadExcelPage("gridCustPgcvPrst", oExcelMetaInfo);
        	});
        },
        setGrid : function() {
            $("#gridCustPgcvPrst").alopexGrid({
        ...
        searchList: function(param) {
            ...
            var _per_page = $("#gridCustPgcvPrst").alopexGrid("pageInfo").perPage;
            
            $.alopex.request("biz.CUSTPGCV@PCUSTPGCV001_pSearchCustPgcvPrst", {
                ...
                success: ["#gridCustPgcvPrst", function(res) {
...
<div id="contents">
    ...
    <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"> <b>고객민원 발생현황</b>
    ...
    <!-- main grid -->
    <div id="gridCustPgcvPrst" data-bind="grid:gridCustPgcvPrst"></div>

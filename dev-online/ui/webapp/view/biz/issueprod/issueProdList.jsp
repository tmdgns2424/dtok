        ...
        setGrid : function() {
            ...
            $("#grid").alopexGrid({
                ...
                columnMapping : [
                    ...
                    { columnIndex : 2, key  : "RGSTR_NM",    	title : "게시자",         align : "center",	 width : "100px" },
                    { columnIndex : 3, key  : "RGST_DTM",       title : "게시일", 			align : "center",	 width : "150px" }
                    ...
                    "cell" : {
    					"click" : function(data, eh, e) {
    						if(data._index.column == 1) {
    			            	...
    			            	$a.navigate("issueProdDtl.jsp", param);
    						}
    					}
    				}
                }
...
<div id="contents">
  ...
  <!--view_list area -->
	<div class="floatL4"> 
		<img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"> <b>이달의 상품 목록</b>
	</div>
  <!-- main grid -->

    ...
    $.alopex.page({
        ...
        setEventListener : function() {
            ...
            $("#btnExcelAll").click(function(){
                ...
                var txid = "biz.AGNTEDU@PAGENTEDU001_pSearchAgentEdu";
        ...
        setGrid : function() {
            $("#grid").alopexGrid({
                ...
                rowInlineEdit : true,
                columnMapping : [
                    { columnIndex : 0, width : "50px",                  title : "번호",			numberingColumn : true              },
                    { columnIndex : 1, key : "EDU_DT",                  title : "교육일자",		align : "center",   width : "100px" },
                    { columnIndex : 2, key : "HDQT_PART_ORG_NM",        title : "본사파트",		align : "center",   width : "100px" },
                    { columnIndex : 3, key : "EDU_NM",                  title : "교육명",		align : "left",     width : "250px" },
                    { columnIndex : 4, key : "EDUT_OWNR_NM",            title : "교육주제",		align : "center",   width : "200px" },
                    { columnIndex : 5, key : "LECTR_NM",                title : "강사명",		align : "center",   width : "90px"  },
                    { columnIndex : 6, key : "STU_MA_COUNT",            title : "참석인원",		align : "center",   width : "70px"  },
                    { columnIndex : 7, key : "RGSTR_NM",                title : "처리자",		align : "center",   width : "90px"  },
                    { columnIndex : 8, key : "RGST_DTM",                title : "처리일",		align : "center",   width : "100px" }
                ],
                on : {
                    ...
                    "cell" : {
                        "dblclick" : function(data, eh, e) {
                            if(data._index.column != 0) {
                                ...
                                $a.navigate("headAgentEduDtl.jsp", param);
                            }
                        }
                    }
                }
        ...
        searchList: function(param) {
            ...
            $.alopex.request("biz.AGNTEDU@PAGENTEDU001_pSearchAgentEdu", {
...
<div id="contents">
    ...
    <div class="content_title">
        <div id="ub_txt6">
            <span class="txt6_img"><b id="sub-title">교육관리</b>
        ...
        <form id="searchForm" onsubmit="return false;">
            ...
            <tr>
                ...
                <td class="tleft" colspan="5">
                    <input id="AGNT_CD" name="AGNT_CD" data-bind="value:AGNT_CD" data-type="textinput" maxlength="6" style="width:170px;" />
                </td>
            </tr>
            </table>
            <div class="ab_pos4">
    ...
    <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>교육관리</b>
        <p class="ab_pos2">

    ...
    $.alopex.page({
        ...
        remain : function(){
            var requestData = $.PSNMUtils.getRequestData("searchForm");
 		    requestData.dataSet.fields.auth = "team";
        ...
        searchList: function(param) {
            ...
            var requestData = $.PSNMUtils.getRequestData("searchForm");
 		    requestData.dataSet.fields.DSM_TYP_ID = "4";
        ...
        messageSnd: function(param) {
            ...
            if( $.PSNM.confirm("I004", ["전송"] ) ){
                ...
                $.alopex.request("biz.SMSMGMT@PSMSMGMT001_pSndMessage", {
                  ...
                  success : function(res) {
                    alert("전송이 완료되었습니다.");
                    $a.navigate("headTeamSmsSndList.jsp", _param)
                    }
                });
            }
        },
        ...
        <div class="sms_section">
            ...
            <div class="textAR" >
                ...
                <p class="textAR fclear">
                    <span class="fright aright" style="width:20%;">

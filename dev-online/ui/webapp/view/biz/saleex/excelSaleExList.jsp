    ...
    $.alopex.page({
        ...
        setEventListener : function() {
        	...
        	$("#btnNew").click(function(){
            	...
            	$a.navigate("excelSaleExRgst.jsp", param);
            });
        	$("#btnExcelAll").click(function(){
        		...
        		var txid = "biz.SALEEX@PEXCELSALEEX001_pSearchExcelSaleEx";
...
<div id="contents">
    ...
    <div class="content_title">
        <div id="ub_txt6">
            <span class="txt6_img"><b id="sub-title">우수영업사례</b>
    ...
    <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>우수영업사례</b>
        <p class="ab_pos2">
